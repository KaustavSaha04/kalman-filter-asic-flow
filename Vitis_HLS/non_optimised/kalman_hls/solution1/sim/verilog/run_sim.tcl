...
if {[file isfile kalman_hw_update.autotvin.dat]} {
	file delete -force kalman_hw_update.autotvin.dat
}

if {[file isfile kalman_hw_update.autotvout.dat]} {
	file delete -force kalman_hw_update.autotvout.dat
}
