...
HLS_SOURCES = ../../../../kalman_test.cpp ../../../../matrix.cpp ../../../../kalman.cpp
...
$(ObjDir)/kalman_test.o: ../../../../kalman_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../kalman_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/kalman_test.d
