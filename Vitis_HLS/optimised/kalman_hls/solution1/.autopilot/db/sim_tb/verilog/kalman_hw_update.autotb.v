...
`define AUTOTB_DUT      kalman_hw_update
`define AUTOTB_DUT_INST AESL_inst_kalman_hw_update
`define AUTOTB_TOP      apatb_kalman_hw_update_top
`define AUTOTB_LAT_RESULT_FILE "kalman_hw_update.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "kalman_hw_update.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_kalman_hw_update_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_obs_pos 1
`define AESL_DEPTH_est_pos 1
`define AESL_DEPTH_est_vel 1
`define AUTOTB_TVIN_obs_pos  "./c.kalman_hw_update.autotvin_obs_pos.dat"
`define AUTOTB_TVIN_obs_pos_out_wrapc  "./rtl.kalman_hw_update.autotvin_obs_pos.dat"
`define AUTOTB_TVOUT_est_pos  "./c.kalman_hw_update.autotvout_est_pos.dat"
`define AUTOTB_TVOUT_est_vel  "./c.kalman_hw_update.autotvout_est_vel.dat"
`define AUTOTB_TVOUT_est_pos_out_wrapc  "./impl_rtl.kalman_hw_update.autotvout_est_pos.dat"
`define AUTOTB_TVOUT_est_vel_out_wrapc  "./impl_rtl.kalman_hw_update.autotvout_est_vel.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 10;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 110;
parameter LENGTH_obs_pos = 1;
parameter LENGTH_est_pos = 1;
parameter LENGTH_est_vel = 1;
...
reg end_obs_pos;
reg [31:0] size_obs_pos;
reg [31:0] size_obs_pos_backup;
reg end_est_pos;
reg [31:0] size_est_pos;
reg [31:0] size_est_pos_backup;
reg end_est_vel;
reg [31:0] size_est_vel;
reg [31:0] size_est_vel_backup;
...
reg dump_tvout_finish_est_pos;

initial begin : dump_tvout_runtime_sign_est_pos
    integer fp;
    dump_tvout_finish_est_pos = 0;
    fp = $fopen(`AUTOTB_TVOUT_est_pos_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_est_pos_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_est_pos_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_est_pos_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_est_pos = 1;
end


reg dump_tvout_finish_est_vel;

initial begin : dump_tvout_runtime_sign_est_vel
    integer fp;
    dump_tvout_finish_est_vel = 0;
    fp = $fopen(`AUTOTB_TVOUT_est_vel_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_est_vel_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_est_vel_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_est_vel_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
