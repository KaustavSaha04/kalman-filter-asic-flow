...
set Library     "hls"
set IPName      "kalman_hw_update"
set Version     "1.0"
set DisplayName "Kalman_hw_update"
set Revision    "1905061849"
...
set xo_kernel_name "kalman_hw_update"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/HP/OneDrive/Desktop/BTP_RND/RND/optimization/kalman_final1/kalman/kalman_hls/solution1"
set debug_dir "C:/Users/HP/OneDrive/Desktop/BTP_RND/RND/optimization/kalman_final1/kalman/kalman_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {kalman_hw_update_mul_32s_17ns_48_1_1
...
## Variables
set Top "kalman_hw_update"
set TopNoPrefix "kalman_hw_update"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 obs_pos W 0x0 "Data signal of obs_pos" {{0 32 obs_pos W 0 "Bit 31 to 0 of obs_pos"}}} {0x18 est_pos R 0x0 "Data signal of est_pos" {{0 32 est_pos R 0 "Bit 31 to 0 of est_pos"}}} {0x1c est_pos_ctrl R 0x0 "Control signal of est_pos" {{0 1 est_pos_ap_vld R 0 "Control signal est_pos_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 est_vel R 0x0 "Data signal of est_vel" {{0 32 est_vel R 0 "Bit 31 to 0 of est_vel"}}} {0x2c est_vel_ctrl R 0x0 "Control signal of est_vel" {{0 1 est_vel_ap_vld R 0 "Control signal est_vel_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 110 II 110}
