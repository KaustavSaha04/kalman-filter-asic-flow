; ModuleID = 'C:/Users/HP/OneDrive/Desktop/BTP_RND/RND/optimization/kalman_final1/kalman/kalman_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_kalman_hw_update_ir(%struct.ap_fixed* nocapture readonly %obs_pos, %struct.ap_fixed* %est_pos, %struct.ap_fixed* %est_vel) local_unnamed_addr #0 {
entry:
  %est_pos_copy1 = alloca %struct.ap_fixed, align 512
  %est_vel_copy2 = alloca %struct.ap_fixed, align 512
  call fastcc void @copy_in(%struct.ap_fixed* %est_pos, %struct.ap_fixed* nonnull align 512 %est_pos_copy1, %struct.ap_fixed* %est_vel, %struct.ap_fixed* nonnull align 512 %est_vel_copy2)
  call void @apatb_kalman_hw_update_hw(%struct.ap_fixed* %obs_pos, %struct.ap_fixed* %est_pos_copy1, %struct.ap_fixed* %est_vel_copy2)
  call fastcc void @copy_out(%struct.ap_fixed* %est_pos, %struct.ap_fixed* nonnull align 512 %est_pos_copy1, %struct.ap_fixed* %est_vel, %struct.ap_fixed* nonnull align 512 %est_vel_copy2)
  ret void
}
...
declare void @apatb_kalman_hw_update_hw(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*)

define void @kalman_hw_update_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*) #6 {
entry:
  call void @copy_out(%struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2)
  call void @kalman_hw_update_hw_stub(%struct.ap_fixed* %0, %struct.ap_fixed* %1, %struct.ap_fixed* %2)
  call void @copy_in(%struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2)
  ret void
}

declare void @kalman_hw_update_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*)
