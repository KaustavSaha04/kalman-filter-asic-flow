...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "kalman_hw_update.autotvin.dat"
	set constFileTvOut       "kalman_hw_update.autotvout.dat"
	set constFileHdlTvIn     "kalman_hw_update.autohdltvin.dat"
	set constFileHdlTvOut    "kalman_hw_update.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
