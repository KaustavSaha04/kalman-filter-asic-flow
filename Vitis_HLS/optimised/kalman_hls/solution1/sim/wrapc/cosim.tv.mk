...
$(ObjDir)/kalman_test.cpp_pre.cpp.tb.o : kalman_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling kalman_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/kalman.cpp_pre.cpp.tb.o : kalman.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling kalman.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
