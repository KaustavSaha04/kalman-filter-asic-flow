...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kalman_hw_update.autotvin_obs_pos.dat"
         "c.kalman_hw_update.autotvout_est_pos.dat"
         "c.kalman_hw_update.autotvout_est_vel.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kalman_hw_update.autotvout_est_pos.dat"
         "rtl.kalman_hw_update.autotvout_est_vel.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
